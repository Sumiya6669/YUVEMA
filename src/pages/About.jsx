        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-12">
          <motion.div {...reveal} className="premium-panel px-7 py-8 md:px-9">
            ...
            <h2 className="section-heading mt-4">
              Профессиональный уход должен быть точным, чистым по логике и сильным по результату
            </h2>
            <p className="mt-5 text-sm leading-8 text-muted-foreground">
              YUVEMA строится вокруг сильных формул, экспертного отбора и сервиса, который не
              отвлекает от главного. Мы оставляем только то, что помогает коже и делает выбор
              уверенным: качество состава, понятную роль продукта и профессиональную поддержку.
            </p>
          </motion.div>
      ...
      <section className="bg-[#FBF7F1] py-20">
        <div className="mx-auto max-w-5xl px-6 lg:px-12">
          <motion.div {...reveal} className="premium-panel px-7 py-10 text-center md:px-10">
            ...
            <h2 className="section-heading mt-4">
              Помогать людям быстрее находить эффективный уход через экспертность, технологию и качественный сервис
            </h2>
            <p className="mx-auto mt-5 max-w-3xl text-sm leading-8 text-muted-foreground">
              Мы даём доступ к профессиональной косметике и упрощаем выбор ухода так, чтобы
              человек мог опираться не на шум обещаний, а на понятные рекомендации, AI-подбор и
              реальную экспертность бренда.
            </p>
          </motion.div>
        </div>
      </section>
