        ...
        <div className="mb-10 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="premium-panel px-7 py-7">
            ...
            <h2 className="mt-4 max-w-xl font-serif text-[2.1rem] leading-[1.02] text-stone">
              Профессиональный уход с аккуратной подачей и понятным сервисом.
            </h2>
            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-muted-foreground">
              Каталог, консультация и B2B-сервис собраны в одной спокойной системе без лишнего
              визуального шума.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-14">
          <div>
            ...
            <p className="mt-5 max-w-sm text-sm leading-relaxed text-muted-foreground">
              Премиальная уходовая косметика для клиентов, косметологов и клиник, которым важны
              эстетика, доверие и реальный результат.
            </p>
          </div>
